...
namespace PSMS_Sub_WebAPI.Common
{
    public class ReadMultilCSV
    {
            ...
            while((strLine = sr.ReadLine()) != null)
            {
                ...
                else
                {
                    if(category == "1")
                    {
                        ...
                        if(dr.ItemArray[0].ToString() == "1028")
                        {
                            dt.Rows.Add(dr);
                        }      
                    }
                    else if(category == "2")
                    {
                        ...
                        if (dr.ItemArray[0].ToString() == "1033")
                        {
                            dt.Rows.Add(dr);
                        }
                    }
        ...
        public DataTable OpenCSVWithIdentifying(string filePath, string category,string Identifying)
        {
